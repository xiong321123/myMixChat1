...
declare global {
    interface Window {
        webkit?: {
            messageHandlers?: {
                MixinContext?: {
                    postMessage: Messengers['getContext'];
                };
                playlist?: {
                    postMessage: Messengers['playlist'];
                };
                reloadTheme?: {
                    postMessage: Messengers['reloadTheme'];
                };
                close?: {
                    postMessage: Messengers['close'];
                };
                getAssets?: {
                    postMessage: ([params, globalCallBackFuncName]: [string[], string]) => void;
                };
                getTipAddress?: {
                    postMessage: ([chainId, globalCallBackFuncName]: [string, string]) => void;
                };
                tipSign?: {
                    postMessage: ([chainId, message, globalCallBackFuncName]: [string, string, string]) => void;
                };
            };
        };
        MixinContext?: {
