...
var nano = _interopDefault(require('nano-seconds'));
...
var axiosRetry__default = _interopDefault(axiosRetry);
...
var Encoder = /*#__PURE__*/function () {
  ...
  _proto.writeUUID = function writeUUID(id) {
    ...
    for (var i = 0; i < uuid$1.length; i += 1) {
...
var newHash = function newHash(data) {
  return Buffer.from(sha3.sha3_256.create().update(data).digest());
};
var sha256Hash = function sha256Hash(data) {
  return Buffer.from(sha256.sha256.create().update(data).digest());
};
var sha512Hash = function sha512Hash(data) {
  return Buffer.from(sha512.sha512.create().update(data).digest());
};
var blake3Hash = function blake3Hash(data) {
  return Buffer.from(blake3.blake3.create({}).update(data).digest());
};
...
var base = /*#__PURE__*/ed25519.ed25519.ExtendedPoint.fromHex('5866666666666666666666666666666666666666666666666666666666666666');
var fn = /*#__PURE__*/modular.Field(ed25519.ed25519.CURVE.n, undefined, true);
...
var setBytesWithClamping = function setBytesWithClamping(x) {
  ...
  wideBytes[31] &= 63;
  wideBytes[31] |= 64;
  var m = fn.create(utils.bytesToNumberLE(wideBytes.subarray(0, 32)));
  return m;
};
var setUniformBytes = function setUniformBytes(x) {
  ...
  var wideBytes = Buffer.alloc(64);
  x.copy(wideBytes);
  var m = fn.create(utils.bytesToNumberLE(wideBytes));
  return m;
};
var setCanonicalBytes = function setCanonicalBytes(x) {
  ...
  var s = fn.create(utils.bytesToNumberLE(x));
  return s;
};
...
var sign = function sign(msg, key) {
  ...
  var s = utils.numberToBytesLE(fn.add(fn.mul(x, y), z), 32);
  return Buffer.concat([r, s]);
};
var newPoint = function newPoint(x) {
  return ed25519.ed25519.ExtendedPoint.fromHex(x.toString('hex'));
};
...
var hashScalar = function hashScalar(k, index) {
  ...
  hash = blake3Hash(Buffer.from(utils.numberToBytesLE(s, 32)));
  hash.copy(src, 0, 0, 32);
  hash = blake3Hash(hash);
  hash.copy(src, 32, 0, 32);
...
var edwards25519 = {
  scalar: fn,
  x25519: ed25519.x25519,
  edwardsToMontgomery: ed25519.edwardsToMontgomery,
  edwardsToMontgomeryPriv: ed25519.edwardsToMontgomeryPriv,
...
var signEd25519PIN = function signEd25519PIN(pin, keystore) {
  ...
  var iterator = Buffer.from(new int64Buffer.Uint64LE(getNanoTime()).toBuffer());
  var time = Buffer.from(new int64Buffer.Uint64LE(Date.now() / 1000).toBuffer());
...
var signAuthenticationToken = function signAuthenticationToken(methodRaw, uri, params, requestID, keystore) {
  if (!keystore.session_id || !uuid.validate(keystore.session_id)) return '';
  var method = 'GET';
...
var signAccessToken = function signAccessToken(methodRaw, uri, params, requestID, keystore) {
  ...
  if (!uuid.validate(keystore.app_id)) return '';
...
function http(keystore, config) {
  ...
  axiosRetry__default(ins, {
    ...
    retryCondition: function retryCondition(error) {
      ...
      isRetryAllowed(error) || axiosRetry.isIdempotentRequestError(error);
    },
  ...
  try {
    ...
    if (memberData.length === total * 16) {
      for (var i = 0; i < total; i++) {
        var id = uuid.stringify(memberData, 16 * i);
        members.push(id);
      }
      return {
        members: members,
...
var decodeNfoMemo = function decodeNfoMemo(hexMemo) {
  ...
  if (hint === 1) {
    ...
    nm.chain = uuid.stringify(decoder.readUUID());
    ...
    nm.collection = uuid.stringify(collection);
...
var buildMixinOneSafePaymentUri = function buildMixinOneSafePaymentUri(params) {
  var _params$trace;
  var address = '';
  if (params.uuid && uuid.validate(params.uuid)) address = params.uuid;else if (params.mainnetAddress && getPublicFromMainnetAddress(params.mainnetAddress)) address = params.mainnetAddress;else if (params.mixAddress && parseMixAddress(params.mixAddress)) address = params.mixAddress;else if (params.members && params.threshold) {
  ...
  var p = {
    ...
    memo: params.memo,
    trace: (_params$trace = params.trace) != null ? _params$trace : uuid.v4(),
...
function websocket(keystore, url, handler, option) {
  ...
  var jwtToken = signAccessToken('GET', '/', '', uuid.v4(), keystore) || '';
  var headers = {
...
exports.CollectibleClient = CollectibleClient;
exports.ConversationClient = ConversationClient;
exports.Decoder = Decoder;
exports.DefaultChain = DefaultChain;
exports.DefaultClass = DefaultClass;
exports.DefaultNftAssetId = DefaultNftAssetId;
exports.Encoder = Encoder;
exports.ExternalClient = ExternalClient;
exports.GroupMembers = GroupMembers;
exports.GroupThreshold = GroupThreshold;
exports.MainAddressPrefix = MainAddressPrefix;
exports.MessageClient = MessageClient;
exports.MintMinimumCost = MintMinimumCost;
exports.MixAddressPrefix = MixAddressPrefix;
exports.MixAddressVersion = MixAddressVersion;
exports.MixinApi = MixinApi;
exports.MixinAssetID = MixinAssetID;
exports.MixinCashier = MixinCashier;
exports.MultisigClient = MultisigClient;
exports.NetworkClient = NetworkClient;
exports.OAuthClient = OAuthClient;
exports.OutputTypeScript = OutputTypeScript;
exports.OutputTypeWithdrawalSubmit = OutputTypeWithdrawalSubmit;
exports.PaymentClient = PaymentClient;
exports.PinClient = PinClient;
exports.ResponseError = ResponseError;
exports.SafeClient = SafeClient;
exports.TIPBodyForSequencerRegister = TIPBodyForSequencerRegister;
exports.TransferClient = TransferClient;
exports.TxVersion = TxVersion;
exports.TxVersionHashSignature = TxVersionHashSignature;
exports.UserClient = UserClient;
exports.UtxoClient = UtxoClient;
exports.WebViewApi = WebViewApi;
exports.base64RawURLDecode = base64RawURLDecode;
exports.base64RawURLEncode = base64RawURLEncode;
exports.bigNumberToBytes = bigNumberToBytes;
exports.blake3Hash = blake3Hash;
exports.buildClient = buildClient;
exports.buildCollectibleMemo = buildCollectibleMemo;
exports.buildMixAddress = buildMixAddress;
exports.buildMixinOneSafePaymentUri = buildMixinOneSafePaymentUri;
exports.buildMultiSigsTransaction = buildMultiSigsTransaction;
exports.buildNfoTransferRequest = buildNfoTransferRequest;
exports.buildSafeTransaction = buildSafeTransaction;
exports.buildSafeTransactionRecipient = buildSafeTransactionRecipient;
exports.buildTokenId = buildTokenId;
exports.bytesToInterger = bytesToInterger;
exports.createAxiosClient = createAxiosClient;
exports.createRequestClient = createRequestClient;
exports.decodeMessage = decodeMessage;
exports.decodeNfoMemo = decodeNfoMemo;
exports.decodeSafeTransaction = decodeSafeTransaction;
exports.deriveGhostPublicKey = deriveGhostPublicKey;
exports.edwards25519 = edwards25519;
exports.encodeSafeTransaction = encodeSafeTransaction;
exports.encodeScript = encodeScript;
exports.encodeTx = encodeTx;
exports.formatUnits = formatUnits;
exports.getCreateAddressTipBody = getCreateAddressTipBody;
exports.getED25519KeyPair = getED25519KeyPair;
exports.getMainnetAddressFromPublic = getMainnetAddressFromPublic;
exports.getMainnetAddressGhostKey = getMainnetAddressGhostKey;
exports.getNanoTime = getNanoTime;
exports.getPublicFromMainnetAddress = getPublicFromMainnetAddress;
exports.getRemoveAddressTipBody = getRemoveAddressTipBody;
exports.getTipPinUpdateMsg = getTipPinUpdateMsg;
exports.getTotalBalanceFromOutputs = getTotalBalanceFromOutputs;
exports.getUnspentOutputsForRecipients = getUnspentOutputsForRecipients;
exports.getUuid = getUuid;
exports.getVerifyPinTipBody = getVerifyPinTipBody;
...
exports.parseMixAddress = parseMixAddress;
exports.parseUnits = parseUnits;
exports.putUvarInt = putUvarInt;
exports.sendRaw = sendRaw;
exports.sha256Hash = sha256Hash;
exports.sha512Hash = sha512Hash;
exports.sharedEd25519Key = sharedEd25519Key;
exports.signAccessToken = signAccessToken;
exports.signAuthenticationToken = signAuthenticationToken;
exports.signEd25519PIN = signEd25519PIN;
exports.signOauthAccessToken = signOauthAccessToken;
exports.signSafeRegistration = signSafeRegistration;
exports.signSafeTransaction = signSafeTransaction;
exports.signTipBody = signTipBody;
exports.sleep = sleep;
exports.tipBody = tipBody;
exports.uniqueConversationID = uniqueConversationID;
